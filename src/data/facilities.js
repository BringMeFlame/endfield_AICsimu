  ...
  '合成制造': [
    {
      ...
      isLowProfile: false,
      ports: [
        { id: 'belt_in_0_3', type: 'item_input', grid: [0, 3], dir: 'down' },
        { id: 'belt_in_1_3', type: 'item_input', grid: [1, 3], dir: 'down' },
        { id: 'belt_in_2_3', type: 'item_input', grid: [2, 3], dir: 'down' },
        { id: 'belt_in_3_3', type: 'item_input', grid: [3, 3], dir: 'down' },
        { id: 'belt_in_4_3', type: 'item_input', grid: [4, 3], dir: 'down' },
        { id: 'belt_in_5_3', type: 'item_input', grid: [5, 3], dir: 'down' },
        { id: 'belt_out_0_0', type: 'item_output', grid: [0, 0], dir: 'up' },
        { id: 'belt_out_1_0', type: 'item_output', grid: [1, 0], dir: 'up' },
        { id: 'belt_out_2_0', type: 'item_output', grid: [2, 0], dir: 'up' },
        { id: 'belt_out_3_0', type: 'item_output', grid: [3, 0], dir: 'up' },
        ...
        { id: 'pipe_out_5_2', type: 'fluid_output', grid: [5, 2], dir: 'right' },
      ],
    },
    {
      id: 'dev_灌装机',
    ...
    },
    {
      ...
      ports: [
        { id: 'pipe_in_0_1', type: 'fluid_input', grid: [0, 1], dir: 'left' },
        { id: 'pipe_in_0_3', type: 'fluid_input', grid: [0, 3], dir: 'left' },
        { id: 'pipe_in_2_4', type: 'fluid_input', grid: [2, 4], dir: 'down' },
        { id: 'pipe_out_4_1', type: 'fluid_output', grid: [4, 1], dir: 'right' },
        { id: 'pipe_out_4_3', type: 'fluid_output', grid: [4, 3], dir: 'right' },
      ],
    },
